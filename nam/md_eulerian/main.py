...
if __name__ == '__main__':
    ...
    data_dir = '../../md_eulerian/all_Data_denoised_eulerian.csv'
    plot_cases = [0, 9]
    strain_comp = 11
    save_df = True
    ...
    time = '2024-06-18T01:33:48.591817'
    ...
    if nam and proj_ratio > 0:
        ...
        if save_df:
            if scale:
                stress = y_scaler.inverse_transform(stress)
            ...
            df.to_csv(
                f'all_Data_predicted_{func_of}{nam_inputs.shape[1]}.csv',
                index=False
            )
    ...
    if scale:
        ...
        stress_train_plot = y_scaler.inverse_transform(stress_train_plot)
        stress_test_plot = y_scaler.inverse_transform(stress_test_plot)
